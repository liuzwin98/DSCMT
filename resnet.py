...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, dilation=1):
        ...
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = conv3x3(planes, planes, stride, dilation=dilation)   # origin:没有dilation
        self.bn2 = nn.BatchNorm2d(planes)
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # x1 = self.avgpool(x1)   # (_,2048,1,1)   batchsize/4 * 2 + batchsize
        # x1 = x1.view(x1.size(0), -1)    # (_,2048)
        # x1 = self.fc1(x1)
        #
